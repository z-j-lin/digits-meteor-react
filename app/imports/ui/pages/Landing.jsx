    ...
    return (
        ...
        <Grid container stackable centered columns={3}>
          ...
          <Grid.Column textalign='center'>
            <Icon size='huge' circular name='users' inverted/>
          ...
          <Grid.Column textalign='center'>
            <Icon size='huge' circular name='file alternate' inverted/>
            <Header as='h1' inverted>Contact Details</Header>
            <Header as='h3' inverted>For each contact, you can saves their name, address, and phone number.</Header>
          </Grid.Column>

          <Grid.Column textalign='center'>
            <Icon size='huge' circular name='calendar check' inverted/>
